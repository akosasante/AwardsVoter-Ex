defmodule AwardsVoter.Context.Voting.Ballots do
  ...
  @spec update_ballot_categories(Ballot.t(), list(Category.t())) :: change_result()
  def update_ballot_categories(ballot, categories) do
  ...
  def get_possible_votes_from_show_or_categories(nil), do: []
